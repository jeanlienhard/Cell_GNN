...
df_initial = pd.read_csv("/home/jeanlienhard/Documents/CellGNN/test_gnn/model_Cell/positions_initiales_periodicite.csv")
df_final = pd.read_csv("/home/jeanlienhard/Documents/CellGNN/test_gnn/model_Cell/positions_optimisees_periodicite.csv")
n_cells = 10
