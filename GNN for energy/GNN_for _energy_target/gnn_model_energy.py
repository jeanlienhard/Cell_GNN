...
class EnergyGNN(nn.Module):
    def __init__(self,node_feature_size, edge_feature_size,latent_size, hidden_size):
        super().__init__()
        self.edge_to_node = edgeToNode(node_feature_size,edge_feature_size, latent_size)
    ...
    def forward(self,x, edge_index, edge_attr):
        x = self.edge_to_node(x,edge_index, edge_attr)
